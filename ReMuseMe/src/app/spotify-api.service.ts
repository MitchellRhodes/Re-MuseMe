...
export class SpotifyApiService {
  ...
  async apiRedirect() {
    ...
    return window.location.href = `https://accounts.spotify.com/authorize?client_id=91f7955d1dba44f4aaac8ad72f54a129&response_type=code&redirect_uri=http://swipify.me/spotify-callback/&code_challenge_method=S256&code_challenge=${codeChallenge}&scope=streaming%20user-read-email%20user-read-private%20user-library-read%20user-library-modify%20user-read-playback-state%20user-modify-playback-state`
  }
  ...
  getAccessToken(code: string, redirect: string) {
    ...
    const body = new HttpParams()
      ...
      .set('code', code)
      .set('redirect_uri', 'http://swipify.me/spotify-callback/')
